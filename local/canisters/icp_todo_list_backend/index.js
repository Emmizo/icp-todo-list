...
import { idlFactory } from './icp_todo_list_backend.did.js';
export { idlFactory } from './icp_todo_list_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICP_TODO_LIST_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_todo_list_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_todo_list_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_todo_list_backend.did.js")._SERVICE>}
 */
export const icp_todo_list_backend = createActor(canisterId);
